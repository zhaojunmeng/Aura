...
public class Main
	...
	private static List<AuraListener> listener = new LinkedList<Main.AuraListener>();
  ...
  public void onCreate(Bundle savedInstanceState) {
	  ...
	  initArg = "";
	  // copy all files from the assets folder to the specified folder (in this case /sdcard/aura
	  CopyAssets("aura");
	 ...
	 @Override
	   public boolean onKeyUp(int keyCode, KeyEvent event) {
	    if(keyCode == KeyEvent.KEYCODE_MENU) { 
	    	...
	    	// want. (see AuraJNI.java for for to handle messages that comes from gamekit)
	    	sendMessage("android", "", "back", "");
	    	onBackPressed();
	    	return true;
	    }
...
//		 System.loadLibrary("OpenAL");
	...
	public static void addListener(AuraListener gkListener){
		listener.add(gkListener);
	}
	
	public static interface AuraListener{
