README for MARS:
This ARTK library version just builds the functionality of pattern recognition. No utils (camera calibration 
or patterns maker), no graphics or windows management. To build the utils, use the "ARToolKit" library in 
internals/libs.
